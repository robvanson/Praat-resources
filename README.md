...
5. [Scripting](https://www.fon.hum.uva.nl/praat/manual/Scripting.html "A *script* is a text that consists of menu commands and action commands. If you *run* the script (perhaps from a ScriptEditor), the commands are executed as if you clicked on them. You can read this tutorial sequentially with the help of the “**< 1**” and “**1 >**” buttons.") at *Praat.org* (scripting reference)
...
- [1.2. Introduction of Praat from EdU HK](https://corpus.eduhk.hk/english_pronunciation/index.php/1-2-introduction-of-praat/)
...
- [Praat Tutorials](https://joeystanley.com/pages/praat-workshops) by *Joey Stanley - University of Georgia*

- [Working with PRAAT (PDF)](https://web.stanford.edu/dept/linguistics/corpora/material/PRAAT_workshop_manual_v421.pdf) by *Pascal van Lieshout - University of Toronto*

- [Using Praat for Linguistic Research](https://github.com/stylerw/usingpraat/raw/main/UsingPraatforLinguisticResearchLatest.pdf) by [*Will Styler*](https://wstyler.ucsd.edu/praat/)

- [Praat Manual from EdU HK](https://corpus.eduhk.hk/english_pronunciation/index.php/our-praat-manual/)

- [Segmentation and Annotation in Praat](https://aletheiacui.github.io/tutorials/segmentation_with_praat.html) by *Aletheia Cui - University of Pennsylvania*

- [Recording with Praat](https://aletheiacui.github.io/tutorials/recording_with_praat.html) by *Aletheia Cui - University of Pennsylvania*
...
- [Scripting and tools](https://www.mauriciofigueroa.cl/04_scripts/04_scripts.html "Here you'll find some Praat programming aids, various scripts,  scripting manuals and workshops about using Praat in production and  perception studies in speech sciences.") by *Mauricio Figueroa - Universidad de Concepción (UDEC)*
